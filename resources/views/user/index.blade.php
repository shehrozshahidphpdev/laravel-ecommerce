                ...
                @foreach ($featuredProducts as $key => $product)
                    <div class="tp-product-sm-item d-flex align-items-center">
                      ...
                      <div class=" tp-product-sm-content">
                        ...
                        <h3 class="tp-product-title">
                          <a href="{{ route('products.show', $product->full_slug) }}">{{ $product->name }}</a>
                        </h3>
                        <div class="tp-product-rating d-sm-flex align-items-center">
                          <div class="tp-product-rating-icon">
                            <span><i class="fa-solid fa-star"></i></span>
            ...
            <div class="mr-20 tp-product-sm-wrapper">
              <div class="tp-product-sm-item d-flex align-items-center">
                ...
                <div class=" tp-product-sm-content">
                  ...
                  <h3 class="tp-product-title">
                    <a href="{{ route('products.show', $product->full_slug) }}">Metal Usb 3.0 Pen Drive 2TB</a>
                  </h3>
                  <div class="tp-product-rating d-sm-flex align-items-center">
                    <div class="tp-product-rating-icon">
                      <span><i class="fa-solid fa-star"></i></span>
              ...
              <div class="tp-product-sm-item d-flex align-items-center">
                ...
                <div class=" tp-product-sm-content">
                  ...
                  <h3 class="tp-product-title">
                    <a href="{{ route('products.show', $product->full_slug) }}">HawkEye Fishtrax</a>
                  </h3>
                  <div class="tp-product-rating d-sm-flex align-items-center">
                    <div class="tp-product-rating-icon">
                      <span><i class="fa-solid fa-star"></i></span>
              ...
              <div class="tp-product-sm-item d-flex align-items-center">
                ...
                <div class=" tp-product-sm-content">
                  ...
                  <h3 class="tp-product-title">
                    <a href="{{ route('products.show', $product->full_slug) }}">Galaxy Tab S6 Android</a>
                  </h3>
                  <div class="tp-product-rating d-sm-flex align-items-center">
                    <div class="tp-product-rating-icon">
                      <span><i class="fa-solid fa-star"></i></span>
