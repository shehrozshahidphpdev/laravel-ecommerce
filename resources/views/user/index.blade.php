...
<x-user.app-layout title="Home Page" :categories="$categories">
      ...
      <div class="swiper-wrapper">
        <div class="tp-slider-item tp-slider-height d-flex align-items-center swiper-slide green-dark-bg">
          <div class="tp-slider-shape">
            <img class="tp-slider-shape-1" src="{{ asset('user/assets/img/slider/shape/slider-shape-1.png') }}"
              alt="slider-shape">
            <img class="tp-slider-shape-2" src="{{ asset('user/assets/img/slider/shape/slider-shape-2.png') }}"
              alt="slider-shape">
            <img class="tp-slider-shape-3" src="{{ asset('user/assets/img/slider/shape/slider-shape-3.png') }}"
              alt="slider-shape">
            <img class="tp-slider-shape-4" src="{{ asset('user/assets/img/slider/shape/slider-shape-4.png') }}"
              alt="slider-shape">
          </div>
          <div class="container">
                  ...
                  <div class="tp-slider-btn">
                    <a href="shop.html" class="tp-btn tp-btn-2 tp-btn-white">Shop Now
                      <svg width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M16 6.99976L1 6.99976" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
        ...
        <div class="tp-slider-item tp-slider-height d-flex align-items-center swiper-slide green-dark-bg">
          ...
          <div class="container">
            <div class="row align-items-center">
              ...
              <div class="col-xl-7 col-lg-6 col-md-6">
                <div class="tp-slider-thumb text-end">
                  <img src="{{ asset('user/assets/img/slider/slider-img-2.png') }}" alt="slider-img">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="tp-slider-item is-light tp-slider-height d-flex align-items-center swiper-slide"
          ...
          <div class="container">
            <div class="row align-items-center">
              ...
              <div class="col-xl-7 col-lg-6 col-md-6">
                <div class="tp-slider-thumb text-end">
                  <img src="{{ asset('user/assets/img/slider/slider-img-3.png') }}" alt="slider-img">
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="container">
      <div class="row row-cols-xl-5 row-cols-lg-5 row-cols-md-4">
            @foreach($featuredCategories as $featuredCategory)
                <div class="col">
                  <div class="mb-40 text-center tp-product-category-item">
                    <div class="tp-product-category-thumb fix">
                      <a href="shop-category.html">
                        <img src="{{ asset('storage/' . $featuredCategory->image) }}" class="object-fit-cover" alt="
                          product-category image">
                      </a>
                    </div>
                    <div class="tp-product-category-content">
                      <h3 class="tp-product-category-title">
                        <a href="shop-category.html">{{ $featuredCategory->name }}</a>
                      </h3>
                      <p>{{ $featuredCategory->products->count() }} Products</p>
                    </div>
                  </div>
              </div>
            @endforeach
            ...
            <div class="tp-feature-icon mr-15">
              <span>
                <svg width="33" height="27" viewBox="0 0 33 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M10.7222 7.94446H5.16667L1.00001 12.1111V19.0556H10.7222V7.94446Z" stroke="currentColor"
            ...
            <div class="tp-feature-icon mr-15">
              <span>
                <svg width="31" height="30" viewBox="0 0 31 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <mask id="mask0_1211_583" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="31"
                    height="30">
    ...
    <div class="container">
      <div class="row align-items-end">
        <div class="col-xl-5 col-lg-6 col-md-5">
          <div class="mb-40 tp-section-title-wrapper">
            ...
            <ul class="nav nav-tabs justify-content-sm-end" id="productTab" role="tablist">
                ...
                <button class="nav-link active" id="new-tab" data-bs-toggle="tab" data-bs-target="#new-tab-pane"
                  ...
                  <span class="tp-product-tab-line">
                    <svg width="52" height="13" viewBox="0 0 52 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M1 8.97127C11.6061 -5.48521 33 3.99996 51 11.4635" stroke="currentColor" stroke-width="2"
              ...
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="topsell-tab" data-bs-toggle="tab" data-bs-target="#topsell-tab-pane"
                  type="button" role="tab" aria-controls="topsell-tab-pane" aria-selected="false">Top Sellers
                  <span class="tp-product-tab-line">
                    <svg width="52" height="13" viewBox="0 0 52 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M1 8.97127C11.6061 -5.48521 33 3.99996 51 11.4635" stroke="currentColor" stroke-width="2"
                        stroke-miterlimit="3.8637" stroke-linecap="round" />
                     ...
                     <div class="col-xl-3 col-lg-3 col-sm-6">
                        <div class="tp-product-item transition-3 mb-25">
                          <div class="tp-product-thumb p-relative fix m-img">
                            ...
                            <!-- product badge -->
                            @if($product->tag && $product->tag->color)
                              <div class="tp-product-badge">
                                  <span 
                                      class="badge"
                                      style="background-color: {{ $product->tag->color->hex_code }}; color: #fff;">
                                      {{ $product->tag->name }}
                                  </span>
                              </div>
                            @endif
                            ...
                            <div class="tp-product-action">
                              <div class="tp-product-action-item d-flex flex-column">
                                <button type="button" class="tp-product-action-btn tp-product-add-cart-btn" data-id="{{$product->id}}">
                                ...
                                <button type="button" class="tp-product-action-btn tp-product-quick-view-btn" data-id="{{ $product->id }}"
                          ...
                          <div class="tp-product-content">
                            ...
                            <div class="tp-product-price-wrapper">
                              @if(!empty($product->discounted_price))
                                <span class="tp-product-price old-price">${{ $product->original_price }}</span>
                                <span class="tp-product-price new-price">${{ $product->discounted_price }}</span>
                              @else
                                <span class="tp-product-price new-price">${{ $product->original_price }}</span>
                              @endif
                            </div>
                          </div>
                        </div>
  ...
  @if($productsOnDeal->isNotEmpty())
    <section class="tp-product-offer grey-bg-2 pt-70 pb-80">
      <div class="container">
        <div class="row align-items-end">
          <div class="col-xl-4 col-md-5 col-sm-6">
            <div class="mb-40 tp-section-title-wrapper">
              <h3 class="tp-section-title">Deal of The Dayyy
          ...
          <div class="col-xl-8 col-md-7 col-sm-6">
            <div class="tp-product-offer-more-wrapper d-flex justify-content-sm-end p-relative z-index-1">
              <div class="mb-40 tp-product-offer-more text-sm-end grey-bg-2">
                <a href="shop.html" class="tp-btn tp-btn-2 tp-btn-blue">View All Deals
                  <svg width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M16 6.99976L1 6.99976" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                      stroke-linejoin="round" />
                    <path d="M9.9502 0.975414L16.0002 6.99941L9.9502 13.0244" stroke="currentColor" stroke-width="1.5"
                      stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
                </a>
          ...
          <div class="col-xl-12">
            <div class="tp-product-offer-slider fix">
              <div class="tp-product-offer-slider-active swiper-container">
                    ...
                    <div class="tp-product-offer-item tp-product-item transition-3 swiper-slide h-100">
                        <div class="tp-product-thumb p-relative fix m-img">
                            ...
                            <div class="tp-product-action-item d-flex flex-column">
                              <button type="button" class="tp-product-action-btn tp-product-compare-btn">
                                <svg width="17" height="21" viewBox="0 0 17 21" fill="none"
                                  xmlns="http://www.w3.org/2000/svg">
                                  <path d="M12.6666 1L16 4.33333L12.6666 7.66667" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                  <path
                          ...
                          <div class="tp-product-add-cart-btn-large-wrapper">
                            <button type="button" class="tp-product-add-cart-btn-large" data-id="{{$product->id}}">
                        ...
                        <div class="tp-product-content">
                          ...
                          <div class="tp-product-countdown" data-countdown data-date="{{ $product->deal_expiration_date?->toIso8601String() }}"">
                ...
                <div class="mt-40 text-center tp-deals-slider-dot tp-swiper-dot"></div>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-4 col-lg-5">
          <div class="mb-40 tp-product-gadget-sidebar">
            <div class="mb-10 tp-product-gadget-categories p-relative fix">
              <div class="tp-product-gadget-thumb">
                <img src="{{ asset('user/assets/img/product/gadget/gadget-girl.png') }}" alt="">
              </div>
              <h3 class=" tp-product-gadget-categories-title">Electronics <br> Gadgets</h3>

              <div class="tp-product-gadget-categories-list">
                <ul>
                  @foreach($electronicProducts->slice(0, 6) as $product)   
                    <li><a href="shop-category.html">{{ strtolower($product->category->name)}}</a></li>
                  @endforeach 
                  </ul>
              </div>
            ...
            <div class="col-xl-4 col-sm-6">
              <div class="tp-product-item p-relative transition-3 mb-25">
                <div class="tp-product-thumb p-relative fix m-img">
                  ...
                  <!-- product badge -->
                  @if($product->tag && $product->tag->color)
                    <div class="tp-product-badge" style="background-color: {{ $product->tag->color_hex_code }}">
                      <span class="product-offer">{{ $product->tag->name }}</span>
                    </div>
                  @endif
                  ...
                  <div class="tp-product-action">
                    <div class="tp-product-action-item d-flex flex-column">
                      ...
                      <button type="button" class="tp-product-action-btn tp-product-quick-view-btn" data-bs-toggle="modal" data-id="{{ $product->id }}"
      ...
      <div class="row align-items-end">
        ...
        <div class="col-xl-7 col-sm-6">
          <div class="tp-product-arrival-more-wrapper d-flex justify-content-end">
            <div class="mb-40 tp-product-arrival-arrow tp-swiper-arrow text-end tp-product-arrival-border">
            ...
            <div class="mr-20 tp-product-sm-wrapper">
                ...
                <div class="tp-product-sm-item d-flex align-items-center">
                  ...
                  <div class=" tp-product-sm-content">
                    ...
                    <div class="tp-product-price-wrapper">
                      <span class="tp-product-price">${{ number_format($product->discounted_price, 2) }}</span>
                    </div>
                  </div>
                </div>
              @if($key == 2)
        ...
        quickViewBtn.forEach(btn => {
          ...
          .then((data) => {
           ...
           console.log(data);
            ...
            let InStock = (data.product.quantity > 0) ? 'In Stock' : 'Out of Stock';
            let shortDescription = data.product.short_description;
            let tag = data.product.tag.name;
            let category = data.product.category.name;
            let productName = data.product.name;
            let mainThumb = document.querySelector('.tp-product-details-nav-main-thumb');
                ...
                data.product.images.forEach((image, index) => {
                    ...
                    imageButtons += `
                        <button class="nav-link ${activeClass}" 
                            ...
                            <img src="${baseStorageUrl + image.image_path}" alt="">
                        </button>
                    `;
                    // Main large images
                    imageTabs += `
            ...
            if(data.product.discounted_price) {
              prices = ` <span class="tp-product-details-price old-price">$${ data.product.original_price }</span>
              <span class="tp-product-details-price new-price">$${ data.product.discounted_price }</span>`;
            } else {
              prices = `<span class="tp-product-details-price old-price">$${ data.product.original_price }`;
            }
            ...
            if(data.product.colors.length > 0) {
             ...
             variations += `
                 <button type="button" class="color tp-color-variation-btn">
                    <span data-bg-color="${ color.hex_code }" style="background-color: ${ color.color }"></span>
          ...
          modalBody.innerHTML = ` 
        <button type="button" class="tp-product-modal-close-btn" data-bs-dismiss="modal">
    ...
    <div class="tp-product-details-thumb-wrapper tp-tab d-sm-flex">
        ...
        <div class="tab-content m-img" 
          ...
          <div class=" tp-product-details-wrapper">
            ...
            <h3 class="tp-product-details-title">${productName}</h3>
            ...
            <p>${shortDescription}... <span>See more</span></p>
