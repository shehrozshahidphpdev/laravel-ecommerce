            ...
            <div class="tp-product-offer-slider-active swiper-container">
              <div class="swiper-wrapper">
                <div class="tp-product-offer-item tp-product-item transition-3 swiper-slide">
                  <div class="tp-product-thumb p-relative fix m-img">
                    <a href="product-details.html">
                      <img src="{{ asset('user/assets/img/product/offer/product-offer-1.jpg') }}" alt="
                        product-electronic">
                    </a>
                ...
                <div class="tp-product-offer-item tp-product-item transition-3 swiper-slide">
                  <div class="tp-product-thumb p-relative fix m-img">
                    <a href="product-details.html">
                      <img src="{{ asset('user/assets/img/product/offer/product-offer-2.jpg') }}" alt="
                        product-electronic">
                    </a>
                ...
                <div class="tp-product-offer-item tp-product-item transition-3 swiper-slide">
                  <div class="tp-product-thumb p-relative fix m-img">
                    <a href="product-details.html">
                      <img src="{{ asset('user/assets/img/product/offer/product-offer-3.jpg') }}" alt="
                        product-electronic">
                    </a>
        ...
        <div class="row">
          <div class="col-xl-4 col-sm-6">
            <div class="tp-product-item p-relative transition-3 mb-25">
              <div class="tp-product-thumb p-relative fix m-img">
                <a href="product-details.html">
                  <img src="{{ asset('user/assets/img/product/product-12.jpg') }}" alt=" product-electronic">
                </a>
          ...
          <div class="col-xl-4 col-sm-6">
            <div class="tp-product-item p-relative transition-3 mb-25">
              <div class="tp-product-thumb p-relative fix m-img">
                <a href="product-details.html">
                  <img src="{{ asset('user/assets/img/product/product-13.jpg') }}" alt=" product-electronic">
                </a>
          ...
          <div class="col-xl-4 col-sm-6">
            <div class="tp-product-item p-relative transition-3 mb-25">
              <div class="tp-product-thumb p-relative fix m-img">
                <a href="product-details.html">
                  <img src="{{ asset('user/assets/img/product/product-14.jpg') }}" alt=" product-electronic">
                </a>
          ...
          <div class="col-xl-4 col-sm-6">
            <div class="tp-product-item p-relative transition-3 mb-25">
              <div class="tp-product-thumb p-relative fix m-img">
                <a href="product-details.html">
                  <img src="{{ asset('user/assets/img/product/product-15.jpg') }}" alt=" product-electronic">
                </a>
          ...
          <div class="col-xl-4 col-sm-6">
            <div class="tp-product-item p-relative transition-3 mb-25">
              <div class="tp-product-thumb p-relative fix m-img">
                <a href="product-details.html">
                  <img src="{{ asset('user/assets/img/product/product-16.jpg') }}" alt=" product-electronic">
                </a>
          ...
          <div class="col-xl-4 col-sm-6">
            <div class="tp-product-item p-relative transition-3 mb-25">
              <div class="tp-product-thumb p-relative fix m-img">
                <a href="product-details.html">
                  <img src="{{ asset('user/assets/img/product/product-17.jpg') }}" alt=" product-electronic">
                </a>
    ...
    <div class="container">
      <div class="tp-product-banner-slider fix">
        <div class="tp-product-banner-slider-active swiper-container">
              ...
              <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6">
                  <div class="tp-product-banner-content p-relative z-index-1">
                    ...
                    <div class="mb-40 tp-product-banner-price">
                ...
                <div class="col-xl-6 col-lg-6">
                  <div class="tp-product-banner-thumb-wrapper p-relative">
                    <div class="tp-product-banner-thumb-shape">
                      ...
                      <img class="tp-offer-shape" src="{{ asset('user/assets/img/banner/banner-slider-offer.png') }}"
                        alt="">
                    </div>
          ...
          <div class=" tp-product-banner-slider-dot tp-swiper-dot">
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="tp-product-arrival-active swiper-container">
              <div class="swiper-wrapper">
                <div class="tp-product-item transition-3 mb-25 swiper-slide">
                  <div class="tp-product-thumb p-relative fix m-img">
                    <a href="product-details.html">
                      <img src="{{ asset('user/assets/img/product/product-6.jpg') }}" alt="
                                                  product-electronic">
                    </a>
                ...
                <div class="tp-product-item transition-3 mb-25 swiper-slide ">
                  <div class="tp-product-thumb p-relative fix m-img">
                    <a href="product-details.html">
                      <img src="{{ asset('user/assets/img/product/product-7.jpg') }}" alt="
                                                  product-electronic">
                    </a>
                ...
                <div class="tp-product-item transition-3 mb-25 swiper-slide ">
                  <div class="tp-product-thumb p-relative fix m-img">
                    <a href="product-details.html">
                      <img src="{{ asset('user/assets/img/product/product-8.jpg') }}" alt="
                                                  product-electronic">
                    </a>
                ...
                <div class="tp-product-item transition-3 mb-25 swiper-slide ">
                  <div class="tp-product-thumb p-relative fix m-img">
                    <a href="product-details.html">
                      <img src="{{ asset('user/assets/img/product/product-9.jpg') }}" alt="
                                                  product-electronic">
                    </a>
                ...
                <div class="tp-product-item transition-3 mb-25 swiper-slide ">
                  <div class="tp-product-thumb p-relative fix m-img">
                    <a href="product-details.html">
                      <img src="{{ asset('user/assets/img/product/product-10.jpg') }}" alt="
                                                  product-electronic">
                    </a>
      ...
      <div class="modal-content">
        <div class="tp-product-modal-content d-lg-flex align-items-start">
          ...
          <div class=" tp-product-details-wrapper">
            ...
            <p>A Screen Everyone Will Love: Whether your family is streaming or video chatting
              with friends tablet
