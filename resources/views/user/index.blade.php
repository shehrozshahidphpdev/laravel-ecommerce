                        ...
                        <div class="tp-product-thumb p-relative fix m-img">
                          ...
                          <div class="tp-product-action">
                            <div class="tp-product-action-item d-flex flex-column">
                              ...
                              <button type="button" class="tp-product-action-btn tp-product-quick-view-btn quick-view-btn"
                                data-bs-toggle="modal" data-bs-target="#producQuickViewModal" data-id="{{ $product->id }}">
