                        ...
                        <div class="breadcrumb__list has-icon">
                           ...
                           @foreach ($data['breadcrumbs'] as $breadcrumb)
                              @if(isset($breadcrumb['slug']))
                                 ...
                                 @endphp   
                                 <span><a  href="{{ url('collections' . $path) }}">{{ $breadcrumb['name'] }}</a></span>
                              @else
                  ...
                  <div class="row">
                     ...
                     <div class="col-xl-5 col-lg-6">
                        <div class="tp-product-details-wrapper">
                           ...
                           <p>{{ Str::limit($product->short_description, 30, '...') }} <span>See more</span></p>
   
                           <!-- price -->
                           <div class="tp-product-details-price-wrapper mb-20">
                            @if($product->discounted_price)
                              <span class="tp-product-details-price old-price">${{ $product->original_price }}</span>
                              <span class="tp-product-details-price new-price">${{ $product->discounted_price }}</span>
                            @else
                              <span class="tp-product-details-price old-price">${{ $product->original_price }}</span>
                            @endif
                              ...
                              <div class="tp-product-details-variation-item">
                                 ...
                                 <div class="tp-product-details-variation-list">
                                  @foreach ($product->colors as $color)
                                    <button type="button" class="color tp-color-variation-btn" @disabled($color->pivot->stock_quantity <= 0)>
                                       <span data-bg-color="{{ $color->hex_code }}" style="background-color: {{ $color->hex_code }}"></span>
                           ...
                           <div class="tp-product-details-action-wrapper">
                              ...
                              <div class="tp-product-details-action-item-wrapper d-flex align-items-center">
                                 ...
                                 <div class="tp-product-details-add-to-cart mb-15 w-100">
                                    <button class="tp-product-details-add-to-cart-btn w-100" data-id="{{ $product->id }}">Add To Cart</button>
                                 </div>
                              </div>
