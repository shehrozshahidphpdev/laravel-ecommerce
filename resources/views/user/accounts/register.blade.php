<x-user.app-layout title="register">
                ...
                <div class="col-xl-6 col-lg-8">
                    <div class="tp-login-wrapper">
                        <div class="tp-login-top text-center mb-30">
                            ...
                            <p>Already have an account? <span><a href="{{ route('user.account.login') }}">Sign
                                        In</a></span></p>
                        </div>
                        <div class="tp-login-option">
                            ...
                            <x-form action="{{ route('user.account.register.store') }}" method="post">
                                @csrf
                                <div class="tp-login-input-wrapper">
                                    ...
                                    <div class="tp-login-input-box">
                                        <div class="tp-login-input">
                                            <input id="email" name="email" type="email" placeholder="admin@mail.com"
                                                value="{{ old('email') }}">
                                        </div>
                                        <div class="tp-login-input-title">
                                    ...
                                    <div class="tp-login-input-box">
                                        <div class="tp-login-input">
                                            <input id="tp_password" name="password" type="password"
                                                placeholder="Min. 6 character" value="{{ old('password') }}">
                                        </div>
                                        @error('password')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    {{-- passsord confirmation --}}
                                    <div class="tp-login-input-box">
                                        <div class="tp-login-input">
                                            <input id="tp_password" name="password_confirmation" type="password"
                                                placeholder="Renenter Password">
                                        </div>
                                        <div class="tp-login-input-eye" id="password-show-toggle">
                                            <span id="open-eye" class="open-eye">
                                                <svg width="18" height="14" viewBox="0 0 18 14" fill="none"
