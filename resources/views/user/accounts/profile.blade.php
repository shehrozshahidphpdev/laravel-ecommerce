<x-user.app-layout title="Profile">
  <!-- profile area start -->
              ...
              <nav>
                <div class="nav nav-tabs tp-tab-menu flex-column" id="profile-tab" role="tablist">
                  <button class="nav-link active" id="nav-profile-tab" data-bs-toggle="tab"
                    ...
                    aria-selected="false"><span><i class="fa-regular fa-user-pen"></i></span>Profile</button>
                  <button class="nav-link" id="nav-information-tab" data-bs-toggle="tab"
                    ...
                    aria-selected="false"><span><i class="fa-regular fa-circle-info"></i></span> Information</button>
                  <button class="nav-link" id="nav-address-tab" data-bs-toggle="tab" data-bs-target="#nav-address"
                    type="button" role="tab" aria-controls="nav-address" aria-selected="false"><span><i
                      ...
                      <div class="row align-items-center">
                          ...
                          <div class="profile__main-inner d-flex flex-wrap align-items-center">
                            <div class="profile__main-thumb">
                              ...
                              <div class="profile__main-thumb-edit">
                                <x-form action="{{ route('user.account.upload-photo') }}" :media="true"
                                  id="avatar-form">
                                  <input type="file" name="avatar" id="profile-thumb-input"
                                    class="profile-img-popup avatar">
                            ...
                            <div class="profile__main-content">
                              <h4 class="profile__main-title">Welcome
                                {{ auth()->guard('customer')->user()?->name ?? "Guest" }}
                              </h4>
                        ...
                        <div class="col-md-6">
                          <div class="profile__main-logout text-sm-end">
                            <x-form action="{{ route('user.account.destroy') }}">
                              <button class="tp-logout-btn">Logout</button>
                            </x-form>
                          </div>
                        </div>
                      </div>
                ...
                <div class="tab-pane fade" id="nav-information" role="tabpanel" aria-labelledby="nav-information-tab">
                  <div class="profile__info">
                    ...
                    <div class="profile__info-content">
                      <x-form action="{{ route('user.account.update-profile') }}">
                        <div class="row">
                          ...
                          <div class="col-xxl-12">
                            <div class="profile__input-box">
                              <div class="profile__input">
                                <input type="text" placeholder="Enter your address" name="location"
                            ...
                            <div class="profile__input-box">
                              <div class="profile__input">
                                <textarea placeholder="Enter your bio"
                                  name="about">{{ $profile->about ?? 'Hi there, this is my bio...'}}</textarea>
                              </div>
                            </div>
                          </div>
                          <div class="col-xxl-12">
