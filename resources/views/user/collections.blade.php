...
<x-user.app-layout title="Collections" :categories="$categories" >
   <main>
              ...
              <div class="row">
                <div class="col-xxl-12">
                    <div class="breadcrumb__content p-relative z-index-1">
                      <h3 class="breadcrumb__title">Shop {{ $breadCrumb }}</h3>
        ...
        <!-- shop area start -->
        {{-- Remove the <form action="#"> currently around just the sidebar --}}

<section class="tp-shop-area pb-120">
  <div class="container">
    {{-- Single form wrapping BOTH sidebar and top sort bar --}}
      ...
      <div class="row">
        ...
        <div class="col-xl-3 col-lg-4">
          <div class="tp-shop-sidebar mr-10">
              ...
              <div class="tp-shop-widget-content">
                <div class="tp-shop-widget-filter">
                  ...
                  <div class="tp-shop-widget-filter-info d-flex align-items-center justify-content-between">
                    ...
                    {{-- Hidden inputs updated by the slider JS --}}
            ...
            {{-- Brands --}}
            <div class="tp-shop-widget mb-50">
              <h3 class="tp-shop-widget-title">Brands</h3>
              <div class="tp-shop-widget-content">
                <div class="tp-shop-widget-checkbox">
                  <ul>
                  ...
                  <ul>
                    @foreach ($categoryFilters as $categoryFilter)
                      <li class="filter-item checkbox">
                        <input
                          type="checkbox"
                          id="cat_{{ $categoryFilter->id }}"
                          name="categories[]"
                          value="{{ $categoryFilter->id }}"
                          {{ in_array($categoryFilter->id, request('categories', [])) ? 'checked' : '' }}
                        >
                        <label for="cat_{{ $categoryFilter->id }}">{{ $categoryFilter->name }}</label>
                      </li>
                    @endforeach
                  </ul>
                </div>
                  ...
                  <div class="tp-shop-top-right d-sm-flex align-items-center justify-content-xl-end">
                    <div class="tp-shop-top-select">
                      <select name="sort" onchange="this.form.submit()">
                        ...
                        <option value="newest"     {{ request('sort') == 'newest'     ? 'selected' : '' }}>New Added</option>
                        <option value="on_sale"    {{ request('sort') == 'on_sale'    ? 'selected' : '' }}>On Sale</option>
                      </select>
                    </div>
                  </div>
                </div>
                                      ...
                                      <div class="tp-product-item-2 mb-40">
                                        <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                            <a href="{{ route('products.show', $product->full_slug) }}">
                                              <img src="{{ asset('storage/' . $product->images[0]->image_path) }}" alt="card-image">
                                            </a>
                                                   <!-- product badge -->
                                            ...
                                            <div class="tp-product-action-2 tp-product-action-blackStyle">
                                              <div class="tp-product-action-item-2 d-flex flex-column">
                                                  ...
                                                  <button type="button" class="tp-product-action-btn-2 tp-product-quick-view-btn" data-id="{{ $product->id }}" 
                                                  ...
                                                  <button type="button" class="tp-product-action-btn-2 tp-product-add-to-wishlist-btn" data-id="{{ $product->id }}">
                                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <span class="tp-product-tooltip tp-product-tooltip-right  tp-product-add-to-wishlist-btn">Add To Wishlist</span>
                                                  </button>
                                              </div>
                                            </div>
                                        </div>
                                        <div class="tp-product-content-2 pt-15">
                                            ...
                                            <div class="tp-product-price-wrapper-2">
                                              @if($product->discounted_price)
                                                <span class="tp-product-price-2 new-price">${{ $product->original_price }}</span>
                                                <span class="tp-product-price-2 old-price">${{ $product->discounted_price }}</span>
                                              @else
                                                <span class="tp-product-price-2 new-price">${{ $product->original_price }}</span>
                                              @endif
                                            </div>
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="tp-product-list-item d-md-flex">
                                            <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                              ...
                                              <a href="{{ route('products.show', $product->full_slug) }}">
                                                  <img src="{{ asset('storage/' . $product->images[0]->image_path) }}" alt="stack-image"  style="max-height: 350px; max-width=350px; object-fit: cover;">
                                              </a>
                                                                   <!-- product badge -->
                                                @if($product->tag && $product->tag->color)
                                                  <div class="tp-product-badge">
                                              ...
                                              <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                  <div class="tp-product-action-item-2 d-flex flex-column">
                                                    <button type="button" class="tp-product-action-btn-2 tp-product-quick-view-btn" data-bs-toggle="modal" data-id="{{ $product->id }}" data-bs-target="#producQuickViewModal">
                                                        <svg width="18" height="15" viewBox="0 0 18 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                          <path fill-rule="evenodd" clip-rule="evenodd" d="M8.99948 5.06828C7.80247 5.06828 6.82956 6.04044 6.82956 7.23542C6.82956 8.42951 7.80247 9.40077 8.99948 9.40077C10.1965 9.40077 11.1703 8.42951 11.1703 7.23542C11.1703 6.04044 10.1965 5.06828 8.99948 5.06828ZM8.99942 10.7482C7.0581 10.7482 5.47949 9.17221 5.47949 7.23508C5.47949 5.29705 7.0581 3.72021 8.99942 3.72021C10.9407 3.72021 12.5202 5.29705 12.5202 7.23508C12.5202 9.17221 10.9407 10.7482 8.99942 10.7482Z" fill="currentColor"/>
                                                          <path fill-rule="evenodd" clip-rule="evenodd" d="M1.41273 7.2346C3.08674 10.9265 5.90646 13.1215 8.99978 13.1224C12.0931 13.1215 14.9128 10.9265 16.5868 7.2346C14.9128 3.54363 12.0931 1.34863 8.99978 1.34773C5.90736 1.34863 3.08674 3.54363 1.41273 7.2346ZM9.00164 14.4703H8.99804H8.99714C5.27471 14.4676 1.93209 11.8629 0.0546754 7.50073C-0.0182251 7.33091 -0.0182251 7.13864 0.0546754 6.96883C1.93209 2.60759 5.27561 0.00288103 8.99714 0.000185582C8.99894 -0.000712902 8.99894 -0.000712902 8.99984 0.000185582C9.00164 -0.000712902 9.00164 -0.000712902 9.00254 0.000185582C12.725 0.00288103 16.0676 2.60759 17.945 6.96883C18.0188 7.13864 18.0188 7.33091 17.945 7.50073C16.0685 11.8629 12.725 14.4676 9.00254 14.4703H9.00164Z" fill="currentColor"/>
                                                        </svg>                                                                       
                                            ...
                                            <div class="tp-product-list-content">
                                              <div class="tp-product-content-2 pt-15">
                                                  ...
                                                  <div class="tp-product-price-wrapper-2">
                                                    @if ($product->discounted_price)
                                                      <span class="tp-product-price-2 old-price">${{ $product->original_price }}</span>
                                                      <span class="tp-product-price-2 new-price">${{ $product->discounted_price }}</span>
                                                      @else
                                                        <span class="tp-product-price-2 old-price">${{ $product->original_price }}</span>
                                                    @endif                                   
                                                  </div>
                                                  ...
                                                  <div class="tp-product-list-add-to-cart">
                                                    <button class="tp-product-list-add-to-cart-btn tp-product-add-cart-btn" data-id="{{ $product->id }}">Add To Cart</button>
                                                  </div>
                                              </div>
                                            </div>
                                        </div>
