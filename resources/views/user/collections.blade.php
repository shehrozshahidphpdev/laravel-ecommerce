...
<x-user.app-layout title="Collections Page" :categories="$categories" >
   <main>
                                   ...
                                   @foreach ($colors as $color)
                                    <li>
                                        <div class="tp-shop-widget-checkbox-circle">
                                          ...
                                          <label for="red">{{ $color->color }}</label>
                                          <span data-bg-color="{{ $color->hex_code }}" style="background= {{ $color->hex_code }}" class="tp-shop-widget-checkbox-circle-self"></span>
                                        </div>
