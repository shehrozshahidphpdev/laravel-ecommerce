    ...
    <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900">
      ...
      <div class="border-b border-gray-200 bg-white px-6 py-4 dark:border-gray-700 dark:bg-gray-900">
        ...
        " />
            ...
            <a href="{{ route('colors.create') }}" class="
          ...
          <tbody class="divide-y divide-gray-100 bg-white dark:divide-gray-100 dark:bg-gray-900">
            @foreach($colors as $color)
              <tr class="transition-colors  dark:hover:bg-gray-800/40">
                <td class="px-6 py-4">
                  <span class="text-sm text-gray-700 dark:text-gray-300">{{ $color->id }}</span>
                </td>
                <td class="px-6 py-4">
                  <span class="text-sm text-gray-700 dark:text-gray-300">{{ $color->color }}</span>
                </td>
                <td class="px-6 py-4">
                  <span class="inline-block border border-gray-300 rounded-full"
                    style="background-color: {{ $color->hex_code }}; width:20px; height:20px;"></span>
                </td>
                <td class="px-6 py-4">
                  <span class="text-sm text-gray-700 dark:text-gray-300">{{ $color->hex_code }}</span>
                </td>
                {{-- delete btn --}}
                <td class="px-6 py-4">
                  <div class="flex flex-row gap-2">
                    <x-form action="{{ route('colors.destroy', $color->id) }}" method="DELETE">
                      <span
