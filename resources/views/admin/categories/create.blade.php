  ...
  <div class="px-4 py-6 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-5xl">
      ...
      <div
        ...
        <x-form action="{{ route('categories.store') }}" :media="true">
          <div class="space-y-6 p-6 sm:p-8">
            <div class="flex flex-row gap-5">
              ...
              <div class="w-full">
                ...
                <input type="text" id="slug" name="slug" placeholder="e.g., electronics, clothing, food"
                  class="block w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-900 placeholder-gray-400 transition-colors focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:placeholder-gray-500 dark:focus:border-blue-400 dark:focus:ring-blue-400/20" />
                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">URL-friendly version (auto-generated if left
                  empty)</p>
                @error('slug')
                  <p class="mt-1.5 text-xs text-rose-600 dark:text-rose-400">{{ $message }}</p>
                @enderror
            ...
            <div>
              ...
              <div class="flex items-start gap-4">
                <!-- Image Preview -->
                <div id="imagePreview"
                  class="relative hidden h-24 w-24 flex-shrink-0  rounded-lg border-2 border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-800">
                  <img id="previewImg" src="" alt="Preview" class="h-full w-full object-cover" />
                ...
                <div class="flex-1">
                  <label for="image"
                    ...
                    <svg class="mb-3 h-10 w-10 text-gray-400 dark:text-gray-500" fill="none" stroke="currentColor"
                      viewBox="0 0 24 24">
            ...
            <div>
              ...
              <div class="flex items-start gap-4">
                ...
                <div id="iconPreview"
                  class="relative hidden h-24 w-24 flex-shrink-0  rounded-lg border-2 border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-800">
                  <img id="previewIcon" src="" alt="Preview" class="h-full w-full object-cover" />
            ...
            <!-- Parent Category -->
            <div>
              <label for="parent_id" class="mb-2 block text-sm font-semibold text-gray-900 dark:text-white">
              ...
              <select id="parent_id" name="parent_id"
                ...
                <option selected value="">None (Top Level Category)</option>
                @foreach ($categories as $category)
                  <option value="{{ $category->id }}">{{ $category->name }}</option>
                @endforeach
              </select>
              <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">Select a parent to create a subcategory</p>
              @error('parent_id')
                <p class="mt-1.5 text-xs text-rose-600 dark:text-rose-400">{{ $message }}</p>
              @enderror
            </div>
