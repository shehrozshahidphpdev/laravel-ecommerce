        ...
        <tbody class="divide-y divide-gray-100 bg-white dark:divide-gray-100 dark:bg-gray-900">
          @foreach($tags as $tag)
            <tr class="transition-colors  dark:hover:bg-gray-800/40">
              <td class="px-6 py-4">
                <span class="text-sm text-gray-700 dark:text-gray-300">{{ $tag->id }}</span>
              </td>
              <td class="px-6 py-4">
                <span class="text-sm  px-5 py-1 rounded-md inline-block text-white"
                  style="background-color: {{ $tag->color->hex_code }}">{{ $tag->name }}</span>
              </td>
              <td class="px-6 py-4">
                <span class="inline-block text-white">{{ $tag->slug }}</span>
              </td>
              {{-- delete btn --}}
              <td class="px-6 py-4">
