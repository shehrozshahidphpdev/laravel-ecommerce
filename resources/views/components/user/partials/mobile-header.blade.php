            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 d-none d-md-block">
                    <div class="tp-header-sticky-menu main-menu menu-style-1">
                        <nav id="mobile-menu">
                            <ul>
                                <!-- categories / menu structure preserved here ... -->
                                <!-- (omitted for brevity; original menu markup remains unchanged) -->
                            </ul>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="tp-header-action d-flex align-items-center justify-content-end ml-50">
                        ...
                        <div class="tp-header-action-item d-none d-lg-block">
                            <a href="{{ route('wishlist') }}" class="tp-header-action-btn">
                                <!-- wishlist icon svg -->
                                <span class="tp-header-action-badge header-wishlist-badge">{{ $wishlistCount ?? 0
                                    }}</span>
                            </a>
                        </div>
                        <div class="tp-header-action-item">
                            <!-- cart button etc remains unchanged -->
                        </div>
