          ...
          <div class="col-xl-4 col-lg-3 col-md-8 col-6">
            <div class="tp-header-main-right d-flex align-items-center justify-content-end">
              <div class="tp-header-login d-none d-lg-block">
                <a href="{{ route('user.account.profile') }}" class="d-flex align-items-center">
                    ...
                    <li class="has-dropdown">
                      ...
                      <ul class="mega-menu tp-submenu">
                        <li>
                          ...
                          <ul>
                            <li>
                              <a href="shop.html"><img src="{{ asset('user/assets/img/header/menu/menu-1.jpg') }}"
                                  alt=""></a>
                            </li>
                            <li>
                        ...
                        <li>
                          ...
                          <ul>
                            <li>
                              <a href="shop.html"><img src="{{ asset('user/assets/img/header/menu/menu-2.jpg') }}"
                                  alt=""></a>
                            </li>
                            <li>
                        ...
                        <li>
                          ...
                          <ul>
                            <li>
                              <a href="shop.html"><img src="{{ asset('user/assets/img/header/menu/menu-3.jpg') }}"
                                  alt=""></a>
                            </li>
                            <li>
                      ...
                      <a href="shop.html">
                        <span>
                          <svg width="17" height="17" viewBox="0 0 17 17" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M14.5 8.5V16H2.50003V8.5" stroke="currentColor" stroke-width="1.4"
                              stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M16 4.75H1V8.5H16V4.75Z" stroke="currentColor" stroke-width="1.4"
                              stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M8.5 16V4.75" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"
                              stroke-linejoin="round" />
                            <path
                        ...
                        <span>
                          <svg width="17" height="16" viewBox="0 0 17 16" fill="none"
                            ...
                            <path
                              ...
                              stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M5.5 14.5H11.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                              stroke-linejoin="round" />
                            <path d="M8.5 11.5V14.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                              stroke-linejoin="round" />
                          </svg>
                        </span>
                        Computers</a>
                        ...
                        <span>
                          <svg width="15" height="18" viewBox="0 0 15 18" fill="none"
                            ...
                            <path
                              ...
                              stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M7.5 14H7.50875" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                              stroke-linejoin="round" />
                          </svg>
                        </span>
                        ...
                        <span>
                          <svg width="18" height="16" viewBox="0 0 18 16" fill="none"
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd"
                              ...
                              stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M13.7527 5.97314H13.7605" stroke="currentColor" stroke-width="1.5"
                              stroke-linecap="round" stroke-linejoin="round" />
                            <path fill-rule="evenodd" clip-rule="evenodd"
