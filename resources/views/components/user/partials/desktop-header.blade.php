              ...
              <div class="tp-header-action d-flex align-items-center ml-50">
                <div class="tp-header-action-item d-none d-lg-block">
                  <a href="{{ route('wishlist') }}"  class="tp-header-action-btn header-wishlist-btn">
                    ...
                    <span class="tp-header-action-badge header-wishlist-badge">{{ $wishlistCount ?? 0 }}</span>
                  </a>
                </div>
                <div class="tp-header-action-item">
                  <button type="button" class="tp-header-action-btn cartmini-open-btn header-cart-btn">
