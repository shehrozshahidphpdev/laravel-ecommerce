...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (typeof window.quickViewUrl === "undefined" || !window.quickViewUrl) {
    console.log("quickViewUrl not available – skipping quick view bindings");
    return;
  }
  ...
  quickViewBtn.forEach((btn) => {
    btn.addEventListener("click", function () {
      ...
      fetch(window.quickViewUrl, {
        ...
        .then((data) => {
          ...
          let mainThumb = document.querySelector(
            ".tp-product-details-nav-main-thumb",
          );
          // define in the layout
            ...
            data.product.images.forEach((image, index) => {
              ...
              imageButtons += `
                        <button class="nav-link ${activeClass}" 
                            ...
                            <img src="${window.baseStorageUrl + image.image_path}" alt="">
                        </button>
                    `;
              // Main large images
              imageTabs += `
    ...
    <div class="tp-product-details-thumb-wrapper tp-tab d-sm-flex">
        ...
        <div class="tab-content m-img" 
          ...
          // Attach behaviour to newly injected quick view modal elements
          (function bindQuickViewBehaviors() {
            const quantityInput = modalBody.querySelector(".tp-cart-input");
            const increaseBtn = modalBody.querySelector(".tp-cart-plus");
            const decreaseBtn = modalBody.querySelector(".tp-cart-minus");
            const addToCartBtn = modalBody.querySelector(
              ".tp-product-details-add-to-cart-btn",
            );
            const cartCountBadge = document.querySelector(".cart-count-badge");
            const cart = document.querySelector(".cartmini__area");
            const subTotalContent = document.querySelector(
              ".cart-mini-subtotal",
            );
            ...
            if (addToCartBtn) {
              ...
              addToCartBtn.onclick = () => {
                ...
                // --- ADD: Show spinner on button ---
                addToCartBtn.innerHTML = spinner;
